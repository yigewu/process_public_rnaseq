...
Copyright (c) Yige Wu, 2024 Email:
\href{mailto:yigewu2012@gmail.com}{\nolinkurl{yigewu2012@gmail.com}}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 0\tabcolsep) * \real{0.0556}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\# Set up \#\# Use current script directory as working directory
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
author: r-yigewu date: `2024-03-08' \\
\end{longtable}
